			...
			<Grid>
				<Col xs={12} sm={4}>
					<Thumbnail src={BioPic} alt={"Cartoon Picture of Kenny Do"}>
						...
						<p>{"Why hello there and welcome to my website. All this data was pulled by my express server using the GitHub API. The express server crunches the raw data to get these stats for me."}</p>
					</Thumbnail>
				...
				<Col xs={12} sm={8}>
					<Col xs={12} sm={12}>
						...
						>
							...
							<i>{"Please don't take this as an accurate representation of my skills but rather take away my ability to data analyse my GitHub Profile :)"}</i>
						</Card>
